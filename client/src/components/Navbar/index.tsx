        ...
        <div className='flex items-center gap-8'>
            ...
            <div className='relative flex h-min w-[200px]'>
                <Search className='absolute left-[4px] top-1/2 mr-2 h-5 w-5 -translate-y-1/2 transform cursor-pointer dark:text-white' />
                    <input 
                        className='w-full rounded border-none bg-gray-100 
                        p-2 pl-8 placeholder-gray-500 focus:border-transparent 
                        focus:outline-none dark:bg-gray-700 dark:text-white 
                        dark:placeholder-white' type='search' placeholder='Kennedy search...'
                    />
            </div>
        </div>
            ...
            <div className='hidden items-center justify-between md:flex'>
                <div className='align-center flex h-9 w-9 justify-center'>
                    {!!currentUserDetails?.profilePictureUrl ? (
                                <Image
                                src={`https://wf-s3-images.s3.us-east-1.amazonaws.com/${currentUserDetails?.profilePictureUrl}`}
                ...
                <button className='hidden rounded bg-blue-500 py-2 text-xs font-bold text-white hover:bg-blue-500 md:block'
