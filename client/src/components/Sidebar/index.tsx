...
<<<<<<< HEAD
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          <Image
            src="https://wf-s3-images.s3.us-east-1.amazonaws.com/logo.png"
            alt="Logo"
            width={40}
            height={40}
          />
...
=======
        ...
        {/* TEAM */}
        <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
            <Image src="https://wf-s3-images.s3.us-east-1.amazonaws.com/logo.png" alt="Logo" width={40} height={40} />
            <div>
                <h3 className='text-md font-bold tracking-wide dark:text-gray-200'>
                   To Kennedy with love
                </h3>
                <div className='mt-1 flex items-start gap-2'>
                    <LockIcon className='mt-[0.1rem] h-3 w-3 text-gray-500 dark:text-gray-400' />
                    <p className='text-xs text-gray-500'>Only Kennedy</p>
                </div>
>>>>>>> parent of 678d75c (added authentication and authorization)
            </div>
        </div>
        {/* NAVBAR LINKS */}
